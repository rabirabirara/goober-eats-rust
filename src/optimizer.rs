...
pub struct DeliveryOptimizer /*<'a>*/ {
    // street_map: &'a StreetMap,
// point_router: &'a PointToPointRouter<'a>,
}

impl DeliveryOptimizer /*<'a>*/ {
    pub fn new(/*_street_map: &'a StreetMap, _point_router: &'a PointToPointRouter*/) -> Self {
        DeliveryOptimizer {
            // street_map,
            // point_router,
        }
    ...
    // fn real_cost(depot: &GeoCoord, deliveries: &Vec<DeliveryRequest>) -> f64 {
    //     0.
    // }
...
impl SimulatedAnnealing for DeliveryOptimizer /*<'a>*/ {
    fn simulated_annealing(
        depot: &GeoCoord,
        deliveries: &Vec<DeliveryRequest>,
    ) -> (Vec<DeliveryRequest>, f64) {
